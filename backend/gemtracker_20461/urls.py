"""gemtracker_20461 URL Configuration
...
admin.site.site_header = "GemTracker"
admin.site.site_title = "GemTracker Admin Portal"
admin.site.index_title = "GemTracker Admin"

# swagger
api_info = openapi.Info(
    title="GemTracker API",
    default_version="v1",
    description="API documentation for GemTracker App",
)
